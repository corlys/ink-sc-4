...
import ABI from '../../artifacts/verifier/verifier.json';
import QueryMethods from '../query/verifier';
import BuildExtrinsicMethods from '../build-extrinsic/verifier';
import TxSignAndSendMethods from '../tx-sign-and-send/verifier';
import MixedMethods from '../mixed-methods/verifier';
import EventsClass from '../events/verifier';
