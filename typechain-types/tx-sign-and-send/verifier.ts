...
export default class Methods {
	...
	*/
	"verify" (
		...
		return txSignAndSend( this.__apiPromise, this.__nativeContract, this.__keyringPair, "verify", (events: EventRecord) => {
			return decodeEvents(events, this.__nativeContract, "verifier");
		}, [data, signer, signature], __options);
	}
